...
import AiClassView from './AiClassView.vue';
import ClassReplayView from './ClassReplayView.vue';
import SmartClassView from './CourseCenterView.vue';

const activeTab = ref('smartClass');
...
<template>
    <div class="smart-class">
        ...
        <div class="main">
            ...
            <div class="content">
                <SmartClassView v-if="activeTab === 'smartClass'" />
                <ClassReplayView v-else-if="activeTab === 'classReplay'" />
                <AiClassView v-else-if="activeTab === 'aiClass'" />
            </div>
        </div>
    </div>
</template>
