package com.saaes.common.core.dao;

import com.saaes.common.core.dao.sql.EntityStaff;
import com.saaes.common.core.dao.sql.MysqlExecutor;
import com.saaes.common.core.dao.sql.PostgreSqlExecutor;
import com.saaes.common.core.dao.sql.SqlExecutor;
import com.saaes.common.core.utils.WebLogs;
...
public class BaseJdbcDaoImpl implements BaseJdbcDao {
    ...
    @Override
    public <E> Integer insert(E entity) {
